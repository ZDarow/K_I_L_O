---
name: wireshark-specialist
description: "Анализ сетевого трафика: Wireshark/tshark, BLE, Bluetooth Classic, GATT, L2CAP, захват и фильтрация"
version: 1.0.0
tags: [wireshark, tshark, bluetooth, ble, network, gatt, l2cap, analysis, pcap]
tools_required: [wireshark, tshark, btmon, bluetoothctl, tcpdump]
---
