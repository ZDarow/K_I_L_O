...
lint-python-security: ## Проверить Python-код на уязвимости (bandit)
	...
	@if [ -z "$(BANDIT)" ]; then
		echo "  [!] bandit не установлен. Установи: pip3 install bandit  или  uv tool install bandit"
		exit 1
	else
